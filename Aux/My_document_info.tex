\title{Theory, models, and  numerical methods \\ for  classical and
  non-classical transport
}
\titleotherlanguage{Theorie, Modelle und numerische Methoden für klassischen und
nicht-klassischen Transport}

\author{ ${}$ }
\address{Ritterstr. 6}
\city{76133 Karlsruhe}
\email{thomas.camminady@kit.edu}
...
%% IMPORTANT: Seminar only: If not "Seminar Intelligente
% Industrieroboter" uncomment this
% \nogrouplogo

%% Name of your institute (Default: IAR-IPR)
% \institute{IANM}
%% Name of your faculty (Default: KIT-Fakultät für Informatik
%\KITfaculty{Department of Mathematics}
%% Address of your institute (Default: Engler-Bunte-Ring 8)
% \instituteaddress{}
%% Insitute City (Default: 76131 Karlsruhe)
% \institutecity{}

\reviewerone{Prof. Dr. Martin Frank}
\reviewertwo{PD Dr. Gudrun Thäter}
\reviewerthree{Prof. em.  Edward Larsen, PhD}
%
