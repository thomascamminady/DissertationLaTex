\begin{figure}[t]
	...
	\caption{Scalar flux for the line-source test case  at $t=1 $ second using the octahedron (lerp) quadrature. 
		The solution is visualized along three cuts: Horizontally (blue), vertically (purple), and diagonally (orange). The reference solution is given in black. The spatial domain is $[-1.5 \text{ cm}, 1.5\text{ cm}]^2$ with $n_x=n_y = 100$. Rows vary in $n_q$ and columns vary in $\delta$, respectively.}
