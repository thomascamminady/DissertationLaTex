...
function createPointsIco(n::Int64,slerpflag=true::Bool)
    points,triangulation  = computeXYZico(n,slerpflag)
	return points,triangulation
end
function computeXYZico(n::Int64,slerpflag)
    # the vertices and faces of the regular icosahedron
    # with vertices on the unit sphere are hard coded
    # and stored in txt files
    vertices = readdlm("quadratures/icosahedron_vertices.txt_low",',',Float64)
    ...
    p,t = getNodesAndTriangulationForSingleTriangle(n,v1,v2,v3,slerpflag)
...
function getNodesAndTriangulationForSingleTriangle(n::Int64,
    pt0::Array{Float64,1},pt1::Array{Float64,1},pt2::Array{Float64,1},slerpflag)
